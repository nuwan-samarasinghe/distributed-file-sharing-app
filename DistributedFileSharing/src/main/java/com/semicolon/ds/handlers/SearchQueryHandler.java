...
public class SearchQueryHandler implements AbstractResponseHandler, AbstractRequestHandler {
    ...
    public void doSearch(String keyword) {
        ...
        LOG.info("*****  SearchQueryHandler -> payload : " + payload);

        String rawMessage = String.format(Constants.MSG_FORMAT, payload.length() + 5, payload);

        LOG.info("*****  SearchQueryHandler -> rawMessage : " + rawMessage);
    ...
    public void handleResponse(ChannelMessage message) {
        ...
        LOG.info("***** handleResponse " + stringToken);
        ...
        LOG.info("***** SearchQueryHandler -> fileName " + fileName);
        ...
        LOG.info("***** SearchQueryHandler -> resultSet " + resultSet);
        ...
        if (fileNamesCount != 0) {
            ...
            LOG.info("***** SearchQueryHandler -> payload if file name count exceeds 0" + payload);
        ...
        if (hops > 0) {
            ...
            for (Neighbour neighbour : neighbours) {
                ...
                LOG.info("***** SearchQueryHandler -> payload in other nodes" + payload);
